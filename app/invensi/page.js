...
const pendudud = [
  [
    { title: "Gelas", value: "1.234", imageUrl: "/gelas.svg" },
    { title: "Piring", value: "567", imageUrl: "/piring.svg" },
    { title: "Soblok", value: "100", imageUrl: "/soblok.svg" }
  ],
  [
    { title: "Meja", value: "600", imageUrl: "/meja.svg" },
    { title: "Kursi", value: "634", imageUrl: "/kursi.svg" },
    { title: "Karpet", value: "150", imageUrl: "/karpet.svg" }
  ]
];
...
const [openRT, setOpenRT] = useState(() =>
    Object.fromEntries(erte.map((rt) => [rt, true]))
  );
